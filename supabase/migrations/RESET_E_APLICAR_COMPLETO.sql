-- ============================================
-- SCRIPT DE RESET COMPLETO E APLICAÇÃO
-- Clínica Carlos Portela - Sistema NPS
-- Data: 18/11/2025
-- ============================================
-- 
-- ⚠️  ATENÇÃO: Este script vai:
-- 1. APAGAR todas as tabelas e dados existentes
-- 2. Recriar toda a estrutura do zero
-- 3. Inserir a pesquisa da Clínica Carlos Portela (17 perguntas)
--
-- 💡 Use este script quando:
-- - Estiver fazendo testes
-- - Quiser começar do zero
-- - Tiver problemas com migrations anteriores
--
-- ⚠️  NÃO USE em produção com dados reais!
-- ============================================
...
-- Apagar tabelas na ordem correta (respeitar foreign keys)
DROP TABLE IF EXISTS public.answers CASCADE;
DROP TABLE IF EXISTS public.survey_responses CASCADE;
DROP TABLE IF EXISTS public.questions CASCADE;
DROP TABLE IF EXISTS public.questionnaires CASCADE;

-- Apagar tipos customizados
...
-- ============================================
-- PARTE 6: DADOS - CLÍNICA CARLOS PORTELA
-- ============================================
...
BEGIN
  ...
  -- ==========================================
  -- SEÇÃO 1: Sobre a sua experiência geral (3 perguntas)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 2: Sobre o atendimento médico (2 perguntas)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 3: Sobre o atendimento institucional (3 perguntas)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 4: Sobre o setor financeiro (2 perguntas)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 5: Sobre tecnologia e estrutura (3 perguntas)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 6: Sobre os bastidores do cuidado (1 pergunta)
  -- ==========================================
  ...
  -- ==========================================
  -- SEÇÃO 7: Sugestões e percepções finais (3 perguntas)
  -- ==========================================
...
BEGIN
  SELECT COUNT(*) INTO total_questionnaires FROM public.questionnaires;
  SELECT COUNT(*) INTO total_questions FROM public.questions;
  
  RAISE NOTICE '============================================';
  RAISE NOTICE '✅ MIGRATION CONCLUÍDA COM SUCESSO!';
  RAISE NOTICE '============================================';
  RAISE NOTICE 'Questionários criados: %', total_questionnaires;
  RAISE NOTICE 'Perguntas criadas: %', total_questions;
  RAISE NOTICE '============================================';
  RAISE NOTICE 'Slug da pesquisa: satisfacao-clinica-carlos-portela';
  RAISE NOTICE 'URL: /survey/satisfacao-clinica-carlos-portela';
  RAISE NOTICE '============================================';
END $$;
